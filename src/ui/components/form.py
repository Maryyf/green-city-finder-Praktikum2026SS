...
def form_block():
    country, starting_point, query, model, cost_preference, carbon_footprint_preference, start_date, end_date = main_component()
    ...
    load_buttons(country, starting_point, query, model, cost_preference, carbon_footprint_preference,
                 max_new_tokens, temperature,
                 start_date, end_date,
                 output,
                 generate_text_fn=generate_text,
                 clear_fn=clear)
    load_examples(country, starting_point, query, model, cost_preference, carbon_footprint_preference, output, generate_text)
